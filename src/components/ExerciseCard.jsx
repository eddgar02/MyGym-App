...
export default function ExerciseCard(props) {
  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-150 sm:flex-wrap">
      <div className="flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4">
        <h4 className="text-3xl hidden sm:inline sm:text-4xl md:text-5xl font-semibold text-green-400">
          {i + 1}
        </h4>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
        ...
        <button
          ...
          className="flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-gree-900 hover:border-green-600 w-full mys duration-200"
        >
